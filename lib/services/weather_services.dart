...
class HoursAndDaysWeatherResponse {
  ...
  HoursAndDaysWeatherResponse(
      {required this.cityName, required this.weatherList});

  factory HoursAndDaysWeatherResponse.fromJson(Map<String, dynamic> json) {
    List<dynamic> weatherData = json['list'];
    List<HoursAndDaysWeatherForecast> weatherList = weatherData
        .map((data) => HoursAndDaysWeatherForecast.fromJson(data))
        .toList();
